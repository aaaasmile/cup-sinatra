...
module ProtCommandConstants
  ...
  SUPP_COMMANDS = {
    ...
    :logout =>  {:liter => "LOGOUT", :cmdh => :cmdh_logout}, 
    ...
    :logout_ok => {:liter => "LOGOUTOK", :cmdh => :cmdh_logoutok},
    :login_error => {:liter => "LOGINERROR", :cmdh => :cmdh_loginerror},
    :player_reconnect => {:liter => "PLAYERRECONNECT", :cmdh => :cmdh_player_reconnect},

    #user operations
    :user_op => {:liter => "USEROP", :cmdh => :cmdh_user_op},
    :user_op_result => {:liter => "USEROPRESULT", :cmdh => :cmdh_user_op_result},
    :user_exist => {:liter => "USEREXIST", :cmdh => :cmdh_user_exist},
    :user_exist_result => {:liter => "USEREXISTRESULT", :cmdh => :cmdh_user_exist_result},
    ...
    #status
    :game_status => {:liter => "GAMESTATUS", :cmdh => :cmdh_game_status},  
  }
  ...
  SERVER_ERROR_INFO = {
    ...
    :pg_remov_req_fail3 => {:code => 3, :info => "Impossibile rimuovere il gioco dal db"},
    :pg_start_error =>{:code => 4, :info => "Impossibile far partire il nuovo gioco"},
  }
